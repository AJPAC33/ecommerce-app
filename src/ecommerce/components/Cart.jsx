...
export const Cart = ({ cart, setCart }) => {
  ...
  return (
    <>
      <div className="flex justify-center py-[40px] px-[50px] bg-[#f1f1f1] border-b-[#9a9a9a]">
        {cart.length === 0 ? (
          ...
          <div className="max-w-[100%] py-[20px] px-[30px]">
            {cart.map((selectedCartProduct, index) => {
              ...
              return (
                <div
                  ...
                  key={id}
                >
                  <div className="py-[20px] px-[20px] bg-[#f1f1f1]">
                    <img
                  ...
                  <div className="flex w-[900px] ml-[60px] mt-[30px] py-[20px] px-[30px]">
                    <div
                      className="min-w-[max-content]"
                      style={{ width: `${maxWidth}px` }}
                    >
                      <h4 className="uppercase text-[16px] text-[#9a9a9a] font-thin tracking-[1.5px]">
                        {category}
                      </h4>
                      <h3
                        className="mt-[20px] text-[#010f1c] text-[22px] font-extralight tracking-[1px]"
                        ref={(el) => (h3Refs.current[index] = el)}
                      >
                        {title}
                      </h3>
                      <p className="mt-[10px] text-[#010f1c] tracking-[1px]">
                        Precio: S/{price}
                      </p>
                      ...
                      <h4 className="text-[#010f1c] text-[22px] mt-[10px]">
            ...
            <div>
              <h2 className="mt-[30px] ml-[50%] text-[22px] uppercase tracking-[1px]">
                Total: S/ {totalPrice}
              </h2>
              <button className="mt-[40px] ml-[53%] py-[10px] px-[20px] text-[#fff] border-none outline-none bg-[#0989ff] cursor-pointer">
                Checkout
              </button>
            </div>
          </div>
